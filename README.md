...
[Online Retail Data Set](https://archive.ics.uci.edu/dataset/352/online+retail) (UCI Machine Learning Repository) - ~542,000 transactions across 8 variables (invoice number, stock code, product description, quantity, invoice date, unit price, customer ID, and country).
...
Yeasmin Akter — [LinkedIn](https://www.linkedin.com/in/yeasmin55/) | [Portfolio](https://yeasminakter.lovable.app)
